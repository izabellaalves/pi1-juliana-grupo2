...
void setup() {
  ...
  // Inicializa a biblioteca TimeLib
  setTime(12, 0, 0, 1, 1, 2020); // Defina um horário inicial (ajuste conforme necessário)
...
void loop() {
  ...
  jsonDoc["horaAtual"] = String(hora) + ":" + String(minuto) + ":" + String(segundo);
